...
export function generateMainNavigationListTemplate() {
  return `
    <li><a id="report-list-button" class="report-list-button" href="#/">Daftar kisah</a></li>
    <li><a id="bookmark-button" class="bookmark-button" href="#/bookmark">kisah Tersimpan</a></li>
  `;
}
...
export function generateReportsListEmptyTemplate() {
  return `
    <div id="reports-list-empty" class="reports-list__empty">
      <h2>Tidak ada kisah tersimpan</h2>
      <p>Saat ini, tidak ada kisah yang disimpan.</p>
    </div>
  `;
}
...
export function generateSaveReportButtonTemplate() {
  return `
    <button id="report-detail-save" class="btn btn-transparent" title="Simpan kisah">
...
export function generateRemoveReportButtonTemplate() {
  return `
    <button id="report-detail-remove" class="btn btn-transparent" title="Hapus kisah">
